...
app.use('/admin-portal/staff-management', auth, staffManagement, staffManagerRoutes)
...
app.use('/admin-portal/sales-management', salesManagerRouters)

// Stock Management Route

app.use('/admin-portal/stock-management', stockManagerRoutes)

// Vehicle Management Route
app.use('/admin-portal/vehicle-management/categories', auth, vehicleManagement, vehicleCategoryRoutes)
app.use('/admin-portal/vehicle-management', auth, vehicleManagement, vehicleRoutes)

// Machine Management Route

app.use('/admin-portal/machine-management/machines', machineRoutes)
app.use('/admin-portal/machine-management/generators', generatorRoutes)
...
app.use('/admin-portal/salary-management/increments', auth, salaryManagement, salaryIncrementRoutes)
app.use('/admin-portal/salary-management', auth, salaryManagement, salaryRoutes)
