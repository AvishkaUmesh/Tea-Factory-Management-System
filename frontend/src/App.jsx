    ...
    <ThemeProvider theme={theme}>
      <Router>
        <Routes>
          ...
          <Route path="/product-management/single-product/edit/:id" element={<UpdateProductDetails />} />
          {/* New links end */}
          <Route path="/product-management/products/productions/:id" element={<ProductUpdatePage />} />
          <Route path="/product-management/production-records" element={<ProductManagement />} />
          <Route path="/product-management/production-records/:id" element={<UpdateProductionDetails />} />
